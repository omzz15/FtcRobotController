...
public class VisionSettings extends RobotPartSettings {
	...
	boolean runVuforiaInRunLoop(){
		return useVuforia && runVuforiaInTeleOp;
	}

	boolean runTensorFlowInRunLoop(){
		return useVuforia && useTensorFlow && runTensorFlowInTeleOp;
	}
